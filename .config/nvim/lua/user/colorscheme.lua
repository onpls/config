...
function palette.load_syntax()
  local syntax = {
    ...
    Folded              = {fg = palette.fg, bg = palette.grey2},
    ...
    StatusLineNC        = {fg = palette.grey, bg = palette.grey2},
    StatusLineTerm      = {fg = palette.fg, bg = palette.popup_black},
    StatusLineTermNC    = {fg = palette.grey, bg = palette.grey2},
    TabLine             = {fg = palette.fg, bg = palette.grey2},
    TabLineFill         = {fg = palette.grey, bg = palette.grey2},
    TabLineSel          = {fg = palette.grey, bg = palette.grey2},
